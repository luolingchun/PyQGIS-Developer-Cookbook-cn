...
Python绑定也可用于QGIS服务，包括Python插件（请参阅[20-QGIS Server Python](20-QGIS服务和Python.md)）和Python绑定，可用于将QGIS服务嵌入到Python应用程序中。
...
!!! 提示
    ...
    Python插件也可用于QGIS服务，更多信息，请参阅[20-QGIS Server Python](20-QGIS服务和Python.md)。
