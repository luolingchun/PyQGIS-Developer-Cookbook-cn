...
Python绑定也可用于QGIS服务，包括Python插件（请参阅[20-QGIS Server Python插件](20-QGIS-Server-Python插件.md)）和Python绑定，可用于将QGIS服务嵌入到Python应用程序中。
...
在Python中创建插件很简单，请参阅[16-开发Python插件](16-开发Python插件.md)以获取详细说明。

------

**小贴士：** Python插件也可用于QGIS服务器（[QGIS as OGC数据服务器](https://docs.qgis.org/master/zh-Hant/docs/user_manual/working_with_ogc/server/index.html#label-qgisserver)），有关详细信息，请参阅[20-QGIS Server Python插件](20-QGIS-Server-Python插件.md)。
